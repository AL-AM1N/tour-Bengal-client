      ...
      <li>
        <details>
          ...
          <ul className="p-2 bg-base-100 w-52 z-10 shadow-md">
            <li>
              <Link to="/bangladesh-tours">BANGLADESH TOURS</Link>
            </li>
            <li>
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="navbar bg-transparent">
          ...
          <div className="navbar-end">
            {user ? (
              <button onClick={handleSignOUt} className="btn bg-[#DF6951] border-none text-white shadow-md" >Log Out</button>
            ) : (
              <Link to="/login" className="btn bg-[#DF6951] border-none text-white shadow-md">
                  Login
              </Link>
            )}
          </div>
