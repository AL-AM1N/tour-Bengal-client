        ...
        <div className="drawer-side is-drawer-close:overflow-visible">
          ...
          <div className="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
            ...
            <ul className="menu w-full grow">
              ...
              {/* List item */}
              <li>
                <Link to="/dashboard/manage-packages">
                  <button
                    className="is-drawer-close:tooltip is-drawer-close:tooltip-right"
                    data-tip="Manage Packages"
                  >
                    {/* Settings icon */}
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <li>
                <Link to="/dashboard/manage-bookings">
                  ...
                  >
                    {/* Settings icon */}
                    <TbBrandBooking className="w-4 h-7" />
                    <span className="is-drawer-close:hidden">
                      Manage Bookings
                    </span>
                  </button>
              ...
              <li>
                <Link to="/dashboard/contact-us">
                  ...
                  >
                    {/* contact icon */}
                    <GrContact className="w-4 h-7" />
                    <span className="is-drawer-close:hidden">Contact Us</span>
                  </button>
                </Link>
              </li>
            </ul>
